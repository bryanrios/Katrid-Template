...
os.system('cp -a /home/alexandre/workspace/katrid/katrid/katrid/theme/less/* ' + base_dir + 'less')
os.system('zip -r katrid-theme.zip README plain-html5 documentation less')
